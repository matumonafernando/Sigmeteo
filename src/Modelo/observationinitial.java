 ...
 * @author INAMETCLIN-3
 */
public class observationinitial {
...
private int dataSourceTimeZone;
    ...
    public observationinitial(String recordedFrom, int describedBy, int obsDatetime, String obsLevel, String obsValue, String flag, int period, int qcStatus, String qcTypeLog, int acquisitionType, String dataForm, String capturedBy, int mark, String temperatureUnits, String precipitationUnits, String cloudHeightUnits, String visUnits, int dataSourceTimeZone) {
